...
function fig_gen()
    ...
    for qorder = (2,3)
        ...
        OPERATORS = (Elastostatic(10.,1.), Elastodynamic(10.,1.,1.,1.))
        # OPERATORS = (Elastodynamic(1,1,1,1),)
        for  op in OPERATORS
            Γ = Nystrom.bean()
...
fig = fig_gen()
fname = "/home/lfaria/Dropbox/Luiz-Carlos/general_regularization/figures/fig2d.svg"
savefig(fig,fname)
